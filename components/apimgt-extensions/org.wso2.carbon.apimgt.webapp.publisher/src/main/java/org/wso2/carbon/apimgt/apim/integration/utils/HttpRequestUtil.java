...
public class HttpRequestUtil {
    public static HttpResponse sendRequest(URL endpoint, String postBody, Map<String, String> headers, String method)
        ...
        try {
            ...
            throw new APIManagementException("An error occurred while invoking " + endpoint + e.getMessage(), e);
        }
    }

    private static HttpResponse sendHttpRequest(HttpURLConnection urlConnection, String postBody,
                                                 Map<String, String> headers, String method) throws APIManagementException {
        int responseCode = 0;
        ...
        try {
            try {
                ...
                throw new APIManagementException("Http URL doesn't support POST", e);
            }
            ...
            try {
                ...
                throw new APIManagementException("IOException while posting data " + e.getMessage(), e);
            } finally {
                if (out != null) {
                    out.close();
                }
            ...
            throw new APIManagementException("An error occurred while invoking " + e.getMessage(), e);
        } finally {
